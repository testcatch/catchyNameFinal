...
public class Tile {
	...
	private static Tile spawn_GrassTile = new SpawnGrassTile(Sprite.spawnGrass,0xff00ff21);
	public static Tile spawnWaterTile = new SpawnWaterTile(Sprite.spawnWater, 0xff0026ff);
	//public static Tile spawnWood = new SpawnWoodTile(Sprite.spawnWood);
	public static Tile spawnBricks1 = new SpawnWallTile(Sprite.spawnBricks1,0xff404040);
	public static Tile spawnBricks2 = new SpawnWallTile(Sprite.spawnBricks2,0xffffd800);
	public static Tile spawnBlood = new SpawnBloodTile(Sprite.spawnBlood,0xffff0000);
